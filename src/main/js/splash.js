define([
    ...
    var progressBarDivWidth = 702;
    var progressBarDivHeight = 58;
    var barButtonWidth = 36;
    ...
    function onLoadDone() {
        ...
        loadingBarButton.style.backgroundImage = 'url(' + resLib.splash.loadingBarButton.src + ')';
        ...
        loadingBarButton.style.height = barButtonWidth;
        loadingBarButton.style.left = barLeft;
    ...
    function onWindowResized() {
        ...
        loadingBarButton.style.left = splashUIController.scale(barLeft);
        loadingBarButton.style.top=splashUIController.scale(10);
    }

    function onMessage(e){
		var percentLoadedStr = e.data.loaded || null;
        var _progressBarWidth = parseInt((progressBarDiv.style.width), 10);
		var posX =_progressBarWidth - parseInt((progressDiv.style.left), 10)* 4 -50;	
